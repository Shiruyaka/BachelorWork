...
HD_PWD='C:/Users/Tomek/Desktop/TabledAsymetricNumeralSystems-master/TabledAsymmetricNumeralSystems/TabledAsymmetricNumeralSystems.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Compressor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Compressor.tcl -notrace
