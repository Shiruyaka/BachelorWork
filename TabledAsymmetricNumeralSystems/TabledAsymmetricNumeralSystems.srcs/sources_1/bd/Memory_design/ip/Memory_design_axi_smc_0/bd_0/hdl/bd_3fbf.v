...
//Date        : Mon Aug 14 14:50:21 2017
//Host        : Tomek-Komputer running 64-bit major release  (build 9200)
//Command     : generate_target bd_3fbf.bd
//Design      : bd_3fbf
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_3fbf,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_3fbf,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=65,numReposBlks=51,numNonXlnxBlks=0,numHierBlks=14,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "Memory_design_axi_smc_0.hwdef" *) 
module bd_3fbf
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
  ...
  m00_exit_pipeline_imp_13LYYB8 m00_exit_pipeline
  ...
  m00_nodes_imp_1PV5GK8 m00_nodes
  ...
  m01_exit_pipeline_imp_16PF850 m01_exit_pipeline
  ...
  m01_nodes_imp_IUXZE6 m01_nodes
  ...
  m02_exit_pipeline_imp_18JXBCK m02_exit_pipeline
  ...
  m02_nodes_imp_HNABAT m02_nodes
  ...
  m03_exit_pipeline_imp_1EZ80AC m03_exit_pipeline
  ...
  m03_nodes_imp_1941DQB m03_nodes
  ...
  m04_exit_pipeline_imp_1MDIHX0 m04_exit_pipeline
  ...
  m04_nodes_imp_1JBCE0Z m04_nodes
  ...
  s00_entry_pipeline_imp_3V25H3 s00_entry_pipeline
       (.aclk(aclk_1),
        .aresetn(aresetn_2),
  ...
  s00_nodes_imp_6QYHBH s00_nodes
  ...
  switchboards_imp_W35CU1 switchboards
...
module m00_exit_pipeline_imp_13LYYB8
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arburst,
...
module m01_exit_pipeline_imp_16PF850
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arburst,
...
module m02_exit_pipeline_imp_18JXBCK
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arburst,
...
module m03_exit_pipeline_imp_1EZ80AC
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arburst,
...
module m03_nodes_imp_1941DQB
  ...
  wire [55:0]m03_w_node_M_SC_PAYLD;
  ...
  assign M_SC_W_payld[55:0] = m03_w_node_M_SC_PAYLD;
...
module m04_exit_pipeline_imp_1MDIHX0
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arburst,
...
module m04_nodes_imp_1JBCE0Z
  ...
  wire [55:0]m04_w_node_M_SC_PAYLD;
  ...
  assign M_SC_W_payld[55:0] = m04_w_node_M_SC_PAYLD;
...
module s00_entry_pipeline_imp_3V25H3
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_3fbf_s00mmu_0 s00_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_wstrb(s_axi_1_WSTRB),
        .s_axi_wvalid(s_axi_1_WVALID));
  bd_3fbf_s00sic_0 s00_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_3fbf_s00tr_0 s00_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
...
module switchboards_imp_W35CU1
   (M00_SC_AR_info,
    M00_SC_AR_payld,
    M00_SC_AR_recv,
    M00_SC_AR_req,
  ...
  wire [55:0]w_switchboard_M00_SC_PAYLD;
  ...
  wire [111:56]w_switchboard_M01_SC_PAYLD;
  ...
  wire [167:112]w_switchboard_M02_SC_PAYLD;
  ...
  wire [223:168]w_switchboard_M03_SC_PAYLD;
  ...
  wire [279:224]w_switchboard_M04_SC_PAYLD;
  ...
  assign M00_SC_W_payld[55:0] = w_switchboard_M00_SC_PAYLD;
  ...
  assign M01_SC_W_payld[55:0] = w_switchboard_M01_SC_PAYLD;
  ...
  assign M02_SC_W_payld[55:0] = w_switchboard_M02_SC_PAYLD;
  ...
  assign M03_SC_W_payld[55:0] = w_switchboard_M03_SC_PAYLD;
  ...
  assign M04_SC_W_payld[55:0] = w_switchboard_M04_SC_PAYLD;
